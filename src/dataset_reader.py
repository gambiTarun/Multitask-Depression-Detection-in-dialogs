...
class DialogReader(DatasetReader):
    ...
    def __init__(
        ...
        self.train_daic, self.dev_daic, self.test_daic = self.load_daicdata()   
        # elif self.daic_or_erisk=="erisk":
        self.train_erisk, self.dev_erisk, self.test_erisk = self.load_eriskdata()

        self.train2 = shuffle(self.train_erisk + self.train_daic)
        self.dev2 = shuffle(self.dev_erisk + self.dev_daic)
        self.test2 = shuffle(self.test_erisk + self.test_daic)
